...
const inventorBirthYears = inventors.map((inventor) => {
    return inventor.year
})
console.log(inventorBirthYears);
...
const sortedAgeInventors = inventors.sort((a, b) => {
      return ((b.passed - b.year)-(a.passed - a.year))
    }
);

console.log(sortedAgeInventors);
